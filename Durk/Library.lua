...
function a:StartLibrary(name, premium)
	name = name or "UILib"
    ...
    props = props or {
      Name = "griffin"
		...
		local c = {}
		function c:CreateContainer(name)
			...
			local d = {}
			function d:CreateDropDown(props)
				props = props or {
					Name = "DropDown",
					Items = {},
			...
			function d:CreateTextBox(CallBack)
			...
			function d:CreateButton(CallBack)
				CallBack = CallBack or function() end
